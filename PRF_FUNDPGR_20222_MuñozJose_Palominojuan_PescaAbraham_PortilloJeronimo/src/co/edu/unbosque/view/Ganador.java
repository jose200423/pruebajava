...
/**
*  clase Ganador es una clase con extencion a un panel se inicializan todos
...
public class Ganador extends JPanel{
	...
	/**
	 * metodo constructor de la clase Ganador inicia un layout, un fonfo, inicializa los componentes del
...
setLayout(new GridBagLayout());
	...
	public void inicializarComponentes() {
		...
		gan = new JLabel("Ganaste");
		gan.setFont(ti);
		gan.setForeground(Color.black);
		c.gridx = 0;
		c.gridy = 0;
		c.gridwidth = 0;
		c.gridheight=1;
		...
		imagen = new JLabel();
		ImageIcon im = new ImageIcon(getClass().getResource("/imagenes/ganador.jpg"));
		imagen.setIcon(new ImageIcon(im.getImage().getScaledInstance(5, 5, Image.SCALE_DEFAULT)));
		imagen.setIcon(im);
		c.gridx = 1;
		c.gridy = 3;
		c.gridwidth = 1;
